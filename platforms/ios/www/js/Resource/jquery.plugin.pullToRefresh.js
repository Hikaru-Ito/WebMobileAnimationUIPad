		...
		var isTouch = !!('ontouchstart' in window),
			...
			html = '<div class="pull-to-refresh">' +
				...
				'<div class="message">' +
					...
					'<span class="pull disnon">' + cfg.message.pull + '</span>' +
					'<span class="release disnon">' + cfg.message.release + '</span>' +
					'<span class="loading disnon">' + cfg.message.loading + '</span>' +
				  '</div>' +
				'</div>';
